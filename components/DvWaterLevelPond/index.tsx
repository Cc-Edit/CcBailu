...
export default function DvWaterLevelPond({ attribute = {}, api = {}, event = [] }: DvProp) {
  ...
  // 增加key 保证每次重新渲染
  return <WaterLevelPond key={new Date().getTime()} style={eleStyle} config={{ ...formatOptions, data }}></WaterLevelPond>;
}